...
export const FunEvents = () => {
  ...
  const formatEventsTableData = (subEvents: FunSubEventItem[]) => {
  ...
  return (
    <div className={styles.funEventsPage}>
                  ...
                  subEvent.map((event) => {
                    return(
                      <div key={event.id} className={styles.subEvent}>
                        ...
                        {
                          event.request && (<MainButton className={styles.requestBtn}>Подать заявку</MainButton>)
                        }
                      </div>
                    )
                  })
