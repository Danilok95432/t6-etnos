...
export const InfoSection:FC<InfoSectionProps> = ({ isCodeAccepted, setIsCodeAccepted }) => {
  return (
    <div className={styles.formSection}>
      ...
      <FlexRow className={styles.groupInputs}>
        <FormInput name='fathname' label='Отчество' />
      ...
      <FlexRow className={styles.groupInputsStart}>
        ...
        <div className={styles.inputwithLabel}>
          <FormInput name='code' isCode setIsCodeAccepted={setIsCodeAccepted} isCodeAccepted={isCodeAccepted} label='Проверочный код' className={styles.noMargin} />
